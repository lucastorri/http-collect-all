...
function addEntry(req, res, metadata, har) {
  ...
  var url = (metadata.ssl ? 'https' : 'http') + '://' + findHeader(req, 'host') + ':' + metadata.port + req.path;
